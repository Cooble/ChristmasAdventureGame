...
public class GameCore extends BasicGame {
    ...
    public static GameCore create() throws SlickException {
        ...
        container.setDisplayMode(gameCore.WIDTH, gameCore.HEIGHT, Game.getSettings().getBoolean(Game.getSettings().FULLSCREEN));
    ...
    private mc.cooble.graphics.Renderable renderable;
    ...
    public void setRenderable(mc.cooble.graphics.Renderable renderable) {
    ...
    public void init(GameContainer gameContainer) throws SlickException {
        try {
            Font big = Font.createFont(Font.PLAIN, Game.saver.loadFont("MinecraftCzechReloaded.ttf"));
