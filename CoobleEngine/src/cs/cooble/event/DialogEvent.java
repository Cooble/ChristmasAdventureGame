...
import cs.cooble.dialog.Dialog;
import cs.cooble.dialog.DialogUtil;
import cs.cooble.entity.Talkable;
    ...
    public void dispatchEvent() {
        ...
        if (dialog.isMultipleComments()) {
            ...
            for (Dialog.Comment comment : comments) {
                ...
                speakEvent.setCustomVoicePath(DIALOG_PATH+"/"+Translator.getLanguage()+"/"+comment.getSpeaker()+"/"+comment.getSrc()+".wav");
